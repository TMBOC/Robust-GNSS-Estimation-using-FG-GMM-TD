...
boxplot(l2_L1_16bit_GPS_TDCS_std,repmat(1,length(bce_L1_16bit_GPS_TDCS_std),1),'position',3, 'symbol','')
boxplot(dcs_L1_16bit_GPS_TDCS_std,repmat(2,length(bce_L1_16bit_GPS_TDCS_std),1),'position',3.25, 'symbol','')
boxplot(mm_L1_16bit_GPS_TDCS_std,repmat(3,length(bce_L1_16bit_GPS_TDCS_std),1),'position',3.5, 'symbol','')
boxplot(bce_L1_16bit_GPS_TDCS_std,repmat(4,length(bce_L1_16bit_GPS_TDCS_std),1),'position',3.75, 'symbol','')

boxplot(l2_L1_8Bit_GPS_TDCS_std,repmat(1,length(bce_L1_8Bit_GPS_TDCS_std),1),'position',5, 'symbol','')
boxplot(dcs_L1_8Bit_GPS_TDCS_std,repmat(2,length(bce_L1_8Bit_GPS_TDCS_std),1),'position',5.25, 'symbol','')
boxplot(mm_L1_8Bit_GPS_TDCS_std,repmat(3,length(bce_L1_8Bit_GPS_TDCS_std),1),'position',5.5, 'symbol','')
boxplot(bce_L1_8Bit_GPS_TDCS_std,repmat(4,length(bce_L1_8Bit_GPS_TDCS_std),1),'position',5.75, 'symbol','')


% % % % positions = [1 1.25 1.5 1.75 3 3.25 3.5 3.75 5 5.25 5.5 5.75];
% % % % color = ['k', 'r', 'b', 'g'];
% % % % color = repmat(color,1,3);
positions = [3 3.25 3.5 3.75 5 5.25 5.5 5.75];
color = ['k', 'r', 'b', 'g'];
...
set(gca,'xticklabel',{'16-bit','8-bit'})
...
grid on;
ylabel('ECEF Positioning Error ( m. )')
